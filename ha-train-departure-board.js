                        ...
                        <div class="popup-stops-list">
                            ${r.map(t=>U`
                                <div class="popup-stop ${t.isPassed?"passed":""} ${t.isCurrent?"current":""} ${t.isBetweenPrevious?"between-previous":""}">
                                    ${t.isBetweenPrevious?U`<div class="popup-train-indicator"></div>`:""}
