 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */var dt;null===(dt=window.HTMLSlotElement)||void 0===dt||dt.prototype.assignedElements;const ct=[{name:"entity",required:!0,selector:{entity:{filter:[{domain:"sensor"}]}}},{name:"title",selector:{text:{}}},{type:"grid",name:"",schema:[{name:"attribute",selector:{text:{}}},{name:"stops_identifier",selector:{select:{options:[{value:"description",label:"Description (Default)"},{value:"tiploc",label:"TIPLOC"},{value:"crs",label:"CRS"}],mode:"dropdown"}}}]}],pt={entity:"Entity",title:"Card Title",attribute:"Data Attribute",stops_identifier:"Station Identifier"},ut={entity:"Select a realtime trains sensor",attribute:"Attribute with departure data (default: departures)",stops_identifier:"How stations are identified in the data"};let ht=class extends st{constructor(){super(...arguments),this._computeLabel=t=>pt[t.name]||t.name,this._computeHelper=t=>ut[t.name]}setConfig(t){this._config=t}render(){return this.hass&&this._config?M`
            <ha-form
                .hass=${this.hass}
                .data=${this._config}
                .schema=${ct}
                    ...
                    <div class="popup-content">
                        <div class="popup-meta">
                            <div class="popup-meta-item">
                                ...
                                <span class="popup-meta-value ${n?"popup-time-cancelled":""} ${a?"popup-time-delayed":""}">
                                    ${r}${a&&null!==s?M` <span class="popup-delay">+${s} min</span>`:""}
                                </span>
                            </div>
                            ${t.platform?M`
                            <div class="popup-meta-item">
