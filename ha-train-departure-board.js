 ...
 */var dt;null===(dt=window.HTMLSlotElement)||void 0===dt||dt.prototype.assignedElements;let ct=class extends rt{setConfig(t){this.config=t}render(){return j`
                ...
                <div class="config-section">
                    ...
                    >
                        ...
                        ${this._getAvailableEntities().map(t=>j`
                            <option value="${t.entity_id}">${t.friendly_name||t.entity_id}</option>
                        `)}
                    </select>
                </div>
                <div class="config-section">
    ...
    `,t([lt({type:Object})],ct.prototype,"config",void 0),t([lt({type:Object})],ct.prototype,"hass",void 0),ct=t([ot("train-departure-board-editor")],ct);let ht=class extends rt{constructor(){super(...arguments),this.departures=[],this.dateCache=new Map,this.lastEntityId=null}static getConfigElement(){return document.createElement("train-departure-board-editor")}static getStubConfig(){return{type:"custom:train-departure-board",title:"Train Departures",entity:"",attribute:"departures"}}setConfig(t){if(!t)throw new Error("Invalid configuration");const e=Object.assign({attribute:"departures"},t);"string"==typeof e.attribute?e.attribute=e.attribute.trim()||"departures":e.attribute="departures",this.config=e}render(){var t,e,i;if(!this.config)return j`<div class="card">No configuration provided</div>`;if(!this.config.entity)return j`<div class="card">Please configure an entity</div>`;const s=null===(e=null===(t=this.hass)||void 0===t?void 0:t.states)||void 0===e?void 0:e[this.config.entity];if(!s)return j`<div class="card">Entity not found: ${this.config.entity}</div>`;this.lastEntityId!==this.config.entity&&(this.dateCache.clear(),this.lastEntityId=this.config.entity);const r=this.config.attribute||"departures",n=null===(i=s.attributes)||void 0===i?void 0:i[r],o=Array.isArray(n)?n:[],a=s.last_updated?new Date(s.last_updated).toLocaleTimeString([],{hour:"2-digit",minute:"2-digit"}):"";return void 0===n&&console.warn(`train-departure-board: attribute "${r}" was not found on entity ${this.config.entity}`),Array.isArray(n)||void 0===n||console.warn(`train-departure-board: attribute "${r}" is not an array, falling back to empty list`),j`
            <ha-card>
                <div class="card">
                    ${o.length>0?j`<div class="departure-list">
        ...
        `}renderDepartureRow(t,e){const i=this.extractTimeLabel(t.scheduled),{statusClass:s,statusLabel:r}=this.getStatusMeta(t),n=this.getCallingAtSummary(t),o=t.platform?t.platform:null;return j`
            <div class="train ${0===e?"next-train":""}">
                <div class="time-wrapper">
                    <span class="scheduled">${i}</span>
                    ${o?j`<span class="platform-badge">Plat ${o}</span>`:""}
                </div>
                <div class="info-box">
                    <div class="destination-row">
                        <h3 class="terminus">${t.destination_name}</h3>
                        <span class="status-pill ${s}">${r}</span>
                    </div>
                    ${n?j`
