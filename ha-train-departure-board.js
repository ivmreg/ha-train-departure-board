                ...
                <div class="popup-card">
                    <div class="modern-header">
                        ...
                        <div class="modern-badges">
                            ...
                            <div class="modern-badge stock-badge stock-${n.category}" style="font-size: 0.85em; padding: 4px 8px;">
                                ${n.label}
                            </div>`:""}
                        </div>
                    </div>
