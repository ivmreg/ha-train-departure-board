...
const LABELS: Record<string, string> = {
    ...
    destination: 'Destination / Calling Point (name or code)',
...
const HELPERS: Record<string, string> = {
    ...
    destination: 'Only show trains matching this destination name or calling point name/code',
    time_offset_minutes: 'Hide trains departing sooner than this',
    stops_input: 'Only show trains that include these stops (also highlighted in the timeline)',
